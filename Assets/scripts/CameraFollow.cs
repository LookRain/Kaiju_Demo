...
public class CameraFollow : MonoBehaviour {
	...
	void Start () {
		...
		//if (player_movement.forePlay) {			
		//	StartCoroutine ("MyCoroutine");
		//}

		//Debug.Log ("count  " + Level_counter.gameCount);

		//player_movement.forePlay = false;
	...
	IEnumerator MyCoroutine() {
		player_movement.isGoing = false;

		yield return new WaitForSeconds (6);

		player_movement.isGoing = true;
	}
